...
const Sidebar = () => {
  return (
    <div
      className="relative flex h-screen max-h-screen w-full max-w-[19rem] flex-col rounded-xl bg-white bg-clip-border p-4 text-gray-700 shadow-xl shadow-blue-gray-900/5">
